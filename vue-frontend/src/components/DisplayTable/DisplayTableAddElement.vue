    ...
    <div id="build-add-elements-container">
        <div id="build-add-elements-left">
            ...
            <div id="build-add-latex-element-container">
                <HoverIcon id="add-latex" hoverText="Raw latex" theme="light" draggable="true" @dragstart="startDrag">
                ...
                <HoverIcon id="add-latex-heading" hoverText="Headings" theme="light" draggable="true" @dragstart="startDrag">
                ...
                <HoverIcon id="add-latex-enum" hoverText="Lists" theme="light" draggable="true" @dragstart="startDrag">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"> 
