    ...
    <div id="build-add-elements-container">
        <div id="build-add-elements-left">
            ...
            <div id="build-add-latex-element-container">
                <HoverIcon id="build-add-latex" hoverText="Raw latex" :light=true>
                ...
                <HoverIcon id="build-add-latex-heading" hoverText="Headings" :light=true>
                ...
                <HoverIcon id="build-add-latex-enum" hoverText="Lists" :light=true>
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
