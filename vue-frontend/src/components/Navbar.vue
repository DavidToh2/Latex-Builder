...
<template>
    <div>
        <div class="navbar-list-left">
            <div class="navbar-item" id="navbar-home" @click="updateView($event)">
                <div class="navbar-item-text">Home</div>
            </div>
            <div class="navbar-item" id="navbar-docs" @click="updateView($event)">
        ...
        <div class="navbar-list-center">
            ...
            <div class="navbar-item" id="navbar-contribute" @click="updateView($event)">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="icon-lg-l">
                <path d="M14.06,9L15,9.94L5.92,19H5V18.08L14.06,9M17.66,3C17.41,3 17.15,3.1 16.96,3.29L15.13,5.12L18.88,8.87L20.71,7.04C21.1,6.65 21.1,6 20.71,5.63L18.37,3.29C18.17,3.09 17.92,3 17.66,3M14.06,6.19L3,17.25V21H6.75L17.81,9.94L14.06,6.19Z">
                </path></svg>
            </div>
            <div class="navbar-item" id="navbar-database" @click="updateView($event)">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="icon-lg-l">
            ...
            <div class="navbar-item" id="navbar-build" @click="updateView($event)">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="icon-lg-l">
            ...
            <div class="navbar-item" id="navbar-document" @click="updateView($event)">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="icon-lg-l">
                <path d="M13,9V3.5L18.5,9M6,2C4.89,2 4,2.89 4,4V20A2,2 0 0,0 6,22H18A2,2 0 0,0 20,20V8L14,2H6Z" />
                </svg>
            </div>
            <div class="navbar-item" id="navbar-drive" @click="updateView($event)">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="icon-lg-l">
            ...
            <div class="navbar-item" id="navbar-latex" @click="updateView($event)">
        ...
        <div class="navbar-list-right">
            <div class="navbar-item" id="navbar-account" @click="updateView($event)">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="icon-lg-l">
